...
layout: base.ejs
title: hyper63.com
description: A service framework for rapid application development
logo: img/hyper63-logo.png
card: /img/hyper63-card.png
---

<div class="mt-5 relative max-w-prose text-gray-500 mx-auto">
  <style>
    p {
      margin-top: 24px;
    }
...
These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and hyper63, LLC ("we," "us" or "our"), concerning your access to and use of the hyper63.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the "Site").
...
We care about data privacy and security. Please review our Privacy Policy https://hyper63.com/privacy. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in the United States.
...
These Terms and Conditions and your use of the Site are governed by and construed in accordance with the laws of the State of South Carolina applicable to agreements made and to be entirely performed within the State/Commonwealth of South Carolina, without regard to its conflict of law principles.
...
The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Charleston County, South Carolina.
...
hyper63, LLC
1740 Omni Blvd, Mount Pleasant, SC 29466
843-469-5856
support@hyper63.com
